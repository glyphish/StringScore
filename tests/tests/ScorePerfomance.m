...
- (id)init {
    if (self = [super init]) {
        ...
        NSString *file = [NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"random words 1000" ofType:@"txt"] encoding:NSUTF8StringEncoding error:NULL];
